...
export default class History extends React.Component {
  ...
  render () {
    return (
      <div>
        <p>British mathematician John Conway invented the Game of Life in 1970. The game involves tracking changing patterns on a two-dimensional grid according to a simple set of rules. Early enthusiasts tracked changes using pencil and paper or chess boards, but computers soon became the preferred tool.</p>
